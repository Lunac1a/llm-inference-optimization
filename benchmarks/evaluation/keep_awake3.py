...
def main():
    ...
    out = root / '.local/research/ruler-final-2026-09-19/resume-3'
    ...
    try:
        ...
        with (out / 'orchestration.log').open('x', encoding='utf-8') as log:
            result = subprocess.run(['wsl', '-d', 'Ubuntu-24.04', '--', 'bash', '-lc',
                '/home/lunacia/.venvs/inference-vllm/bin/python /mnt/d/Lunacia/Inference/benchmarks/evaluation/resume3.py'],
